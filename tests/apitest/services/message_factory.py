...
class PaletteMessageFactory(MessageFactory):
    ...
    def create_message(self, palette_id: int, color_id: int, r: int, g: int, b: int) -> OSCRequest:
...
class MultiLanguageMessageFactory:
    ...
    def create_palette_message(self, palette_id: int, color_id: int, r: int, g: int, b: int) -> OSCRequest:
